...
v0.2.9 P1 剩余项已全部完成。接下来建议：

1. **Phase 3 AI 增强** — 继续深挖 AI 场景，可考虑：
   - 流式输出（streaming）替代整段返回
   - 更多 AI action：摘要、改写语气、生成代码块
   - AI 辅助标题生成
2. **P2 功能完善** — Markdown 导出、骨架屏、空状态引导、版本历史
3. **编辑器增强** — 图片/附件插入（Phase 4）
...
**当前版本**：v0.2.9，GitHub 已 push，tag 已打。
...
- 或继续 **P2 功能完善** — Markdown 导出、骨架屏、空状态引导、版本历史
