...
v0.3.0（Markdown 互操作 + 图片插入）已全部完成。接下来建议：

1. **Phase 3 AI 增强** — 继续深挖 AI 场景，可考虑：
   - 流式输出（streaming）替代整段返回
   - 更多 AI action：摘要、改写语气、生成代码块
   - AI 辅助标题生成
2. **P2 功能完善** — 骨架屏、空状态引导、版本历史、Undo/Redo
3. **编辑器增强** — 表格块、附件文件（非图片）插入、代码块语法高亮

**当前判断**：Phase 3 AI 增强和 P2 功能完善可以并行推进。
